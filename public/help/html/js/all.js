...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Título","1. Menu","2. Dashboard","3. Menu Gestão","4. Menu Configurações","3.1. Acompanhamento de tickets","3.2. Solicitar relatório","4.1. Tipos de documentos","4.2. Templates","4.3. Configuração de Url","4.1.1. Tipos de documentos configurados ","4.1.2. Tipo de documento novo","4.2.1. Consultar ou excluir","4.2.2. Criar template","4.3.1. Consultar","4.3.2. Nova configuração"],
    DREX_NODE_LINKS: ["index.htm","menu.htm","dashboard.htm","menu_gestao.htm","menu_configuracoes.htm","acompanhamento_de_tickets.htm","solicitar_relatorio.htm","tipos_de_documentos.htm","templates.htm","configuracao_de_url.htm","tipos_de_documentos_configurados_.htm","tipo_de_documento_novo.htm","consultar_ou_excluir.htm","criar_template.htm","consultar.htm","nova_configuracao.htm"],
    DREX_NODE_CHILD_START: [1,5,5,5,7,10,10,10,12,14,16,16,16,16,16,16],
    DREX_NODE_CHILD_END: [5,5,5,7,10,10,10,12,14,16,16,16,16,16,16,16],
    DREX_MENU_TYPE: 2,
...
DR_EXPLAIN.data_search = {
    ...
    DREXPLAIN_NOT_FOUND: "Nada encontrado",
    DREXPLAIN_EMPTY_STRING: "Por favor insira um texto para procurar!",
    DREXPLAIN_IN_PROGRESS: "A procurar...",
    DREXPLAIN_PREVIEW_MODE_SEARCH_IS_DISABLED_NOTICE : "No modo de pr&#x00E9;-visualiza&#x00E7;&#x00E3;o a procura est&#x00E1; desligada",
    DREXPLAIN_ERROR_LOCAL_SEARCH : "N&#x00E3;o &#x00E9; poss&#x00ED;vel fazer download de ficheiros de &#x00ED;ndice de pesquisa. Fa&#x00E7;a upload de ficheiros HTML para um servidor web e aceda-lhes via URL come&#x00E7;ando com https:// or http:// .",
    DREXPLAIN_ERROR_REMOTE_SEARCH : "N&#x00E3;o &#x00E9; poss&#x00ED;vel fazer download de ficheiros de &#x00ED;ndice de pesquisa. Solicite ao seu administrador do servidor web para permitir o download de ficheiros com a extens&#x00E3;o .json ou contacte help@drexplain.com. C&#x00F3;digo de erro: {0}"
